...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://EBISPOT.github.io/cohort-ontology/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://EBISPOT.github.io/cohort-ontology/). 
